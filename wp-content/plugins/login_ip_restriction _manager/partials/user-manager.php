            ...
            <div class="filter-container">
                <div class="filter-area">
                    <form autocomplete="off" data-inited-validation="1" id="submit_user_form">
                        ...
                        <div class="filter-select">
                            <input type="hidden" name="filter-select-roles"
                        ...
                        <div class="filter-select">
                            <input type="hidden" name="filter-select-companies"
                        ...
                        <div class="filter-select date-field">
                            <input type="text" name="daterange" class="select-date-picker" value="ssss"
                ...
                <div class="custom-table-body">
                    <div class="custom-table-row">
                        ...
                        <div class="table-body-col table-body-col-mail"><a
                                href="mailto:jillrhodes@miller.com">jillrhodes@miller.com</a></div>
                        ...
                        <div class="table-body-col table-body-col-buttons">
                            ...
                            <div class="manage-user-edit-ctn">
                                <a href="#" class="manage-user-edit-button"></a>
                            </div>
