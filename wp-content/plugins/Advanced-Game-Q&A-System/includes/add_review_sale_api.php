...
<div class="api-form-main">
    ...
    <div class="api-form-ctn">
        <div class="api-form-wrapper" id="UN">
            <form autocomplete="off" id="add-sale-review-form-api" class="custom-form" novalidate="novalidate"
                data-inited-validation="1">
                <div class="form-field required">
                    <input type="hidden" name="review-id" value="<?php echo $add_review_sale_id; ?>">
                    ...
                    <select name="provider-name" disabled id="provider-name">
                        <option value="<?php echo $revenu_data_edit->question; ?>" selected>
                            <?php echo $revenu_data_edit->question; ?></option>
                    </select>
                </div>
                <!-- New Input type -->
                <div class="form-field required">
                            ...
                            <ul>
                                <?php foreach ($rows_type_names as $row_type) { ?>
                                    <li data-value="<?php echo $row_type['id']; ?>"
                                        ...
                                        data-id-cat="<?php echo $row_type['game_category_id']; ?>"><?php echo $row_type['name']; ?>
                                    </li>
                                <?php } ?>
                            </ul>
                        </div>
