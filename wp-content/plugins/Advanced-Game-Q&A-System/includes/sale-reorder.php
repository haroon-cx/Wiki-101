    ...
    jQuery(document).ready(function($) {
        ...
        $('.sort-by-dropdown-lists ul li').on('click', function() {
            ...
            $tiles.sort(function(a, b) {
                var priceA = parseFloat($(a).find('.agqa-selling-price-title h2').text().replace(
                    '%', '').trim());
                var priceB = parseFloat($(b).find('.agqa-selling-price-title h2').text().replace(
                    '%', '').trim());
        ...
        $('.sort-by-reset-button').on('click', function() {
            ...
            $('.reorder-selling-price-tiles').append(
                items); // Append the sorted items to the parent container
