                        ...
                        <div class="faq-accordion">
                            ...
                            <div class="faq-accordion-bottom">
                                ...
                                <div class="faq-accordion-icon">
                                    ...
                                    <span class="unlike-coounting">12</span>
                                </button>
                                <button class="faq-accordion-button copy-button">
                                <div class="faq-accordion-icon">
                                    <img src="<?php echo AGQA_URL ?>assets/images/copy-text-icon.svg" alt="Copy Icon">
                                </div>    
                                    <span>Copy</span>
                                </button>
                                <a href="<?php echo esc_url(home_url('faq/') . '?edit=' . $faq_value->id) ; ?>" class="faq-accordion-button edit-button">
                                    <div class="faq-accordion-icon">
                                ...
                                <div class="faq-accordion-icon">
                                    <img src="<?php echo AGQA_URL ?>assets/images/alert-icon.svg" alt="Report Icon">
                                </div>    
                                    <span>Report</span>
                                </button>
