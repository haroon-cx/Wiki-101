<div class="faq-form-ctn">
    ...
    <div id="faq-add-form" class="faq-form">
            <form autocomplete="off" id="add-form-faq" class="custom-form" novalidate="novalidate" data-inited-validation="1">
                ...
                <div class="form-field required">
                    ...
                    <div class="form-field-editor">
                        <textarea name="faq-answer" id="editor-add-faq" class="editor-faq" required placeholder="Please enter a note"></textarea>
                    </div>
                </div>
