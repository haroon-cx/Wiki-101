<div class="faq-form-ctn">
    ...
    <div id="faq-add-form" class="faq-form">
        <?php if (!empty($faq_data)) {
             foreach ($faq_data as $faq_value) { ?>
                <form autocomplete="off" id="edit-form-faq" class="custom-form" novalidate="novalidate" data-inited-validation="1">
                    <div class="form-field required">
                        <input type="hidden" name="faq-id" value="<?php echo $add_faq_edit?>">
                        <label for="faq-title"><span>* </span>Title</label>
                        <input type="text" name="faq-question" id="faq-title" required placeholder="Description" value="<?php echo $faq_value->question; ?>">
                    </div>
                    <div class="form-field required">
                    ...
                    <input type="hidden" name="faq-category" id="issue_type" required="" value="<?php echo $faq_value->faq_category; ?>">
                    </div>
                    </div>
                    <div class="form-field required">
                        <label for="editor-add-faq"><span>* </span>Details</label>
                        <div class="form-field-editor">
                            <textarea name="faq-answer" id="editor-add-faq" class="editor-faq" required placeholder="Please enter a note"><?php echo $faq_value->answer; ?></textarea>
