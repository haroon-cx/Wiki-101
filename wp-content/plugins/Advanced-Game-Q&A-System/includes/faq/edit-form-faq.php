<div class="faq-form-ctn">
    ...
    <div class="faq-add-form-ctn">
        <div id="faq-add-form" class="faq-form">
            ...
            <form autocomplete="off" id="edit-form-faq" class="custom-form" novalidate="novalidate"
                ...
                <div class="form-field required">
                    ...
                    <div class="form-field-editor">
                        <textarea name="faq-answer" maxlength="3000" id="editor-add-faq" class="editor-faq" required
