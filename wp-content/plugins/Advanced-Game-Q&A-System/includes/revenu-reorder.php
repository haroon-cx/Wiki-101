    ...
    <div class="reorder-ctn">
        <div class="reorder-popup">
            ...
            <?php if ($revenu_data) {?>
                <div class="reorder-selling-price-tiles">
                    <?php foreach ($revenu_data as $rev_item) {?>
                        <div class="reorder-selling-price-tile" data-revenu-id="<?php echo $rev_item->id; ?>">
                            ...
                            <div class="selling-price-tile-item agqa-selling-price-title">
                                ...
                                <h2><?php echo esc_html(number_format($rev_item->selling_price, 0)); ?>%</h2>
                            </div>
                            <div class="selling-price-tile-item">
                                <span>API Cost (%)</span>
                                <h2><?php echo esc_html(number_format($rev_item->api_cost, 0)); ?>%</h2>
                            </div>
                        </div>
                    <?php }?>
                </div>
            ...
            <div class="agqa-popup-form-field agqa-popup-form-buttons d-flex">
                <form id="agqa-sort-revenue">
                    <input type="hidden" name="sort-by-revenue">
...
<script>
    ...
    $('.sort-by-reset-button').on('click', function() {
        ...
        items.sort(function(a, b) {
            var idA = $(a).data('revenu-id');
            var idB = $(b).data('revenu-id');
