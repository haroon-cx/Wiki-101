...
function merged_sale_api_ui_shortcode()
{
    ...
    $table_sales = $wpdb->prefix . 'agqa_sales';
    $table_category = $wpdb->prefix . 'game_category';
    $table_type = $wpdb->prefix . 'game_type';
    $table_reorder = $wpdb->prefix . 'reorder_sales';
    ...
    $order_by = "CAST(r.min_revenue_share AS DECIMAL(10,2)) " . strtoupper($sort_order) . ", r.id DESC";
    ...
    ob_start();
    if ($add_review_sale_id) {
        include 'add_review_sale_api.php';
    }
    ...
    if ($add_revenue_id) {
        include 'add-sale-form.php';
    }
    include 'sale-reorder.php';
    include 'report-form.php';
?>
    <!-- HEADING AREA - PRESERVED -->
    <?php if ($edit_revenue_id == 0 && $add_revenue_id == 0  && $edit_review_sale_id == 0 && $add_review_sale_id == 0) { ?>
        <div class="merged-ui-wrapper">
            <!--  Heading at Top -->
            <div class="api-heading-wrapper">
                <h1 class="text-2xl font-semibold mb-2 text-purple-400 select-none fz">Sale</h1>
                            ...
                            <div class="api-card-header api-toggle-header">
                                <div class="api-price-api-cost">
                                    <div class="api-price-section">
                                        ...
                                        <h2 class="large-text"><?php echo esc_html(number_format($item->min_revenue_share, 0)); ?>%
                                        </h2>
                            ...
                            <div class="api-details" <?php echo $class_block; ?>>
                                <div class="api-info-grid">
                                    ...
                                    <div class="api-info-grid-item">
                                        ...
                                        <h2 class="api-info-value"><?php echo $item->representative_name; ?>
                                        </h2>
                                    </div>
                                    <div class="api-info-grid-item">
